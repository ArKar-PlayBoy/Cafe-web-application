...
<body x-data="{
    ...
    <div class="fixed inset-0 z-[-1] pointer-events-none opacity-40 dark:opacity-20">
        <div class="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] rounded-full bg-indigo-400 dark:bg-indigo-600 blur-[120px] mix-blend-multiply dark:mix-blend-lighten"></div>
        <div class="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] rounded-full bg-violet-400 dark:bg-violet-600 blur-[120px] mix-blend-multiply dark:mix-blend-lighten"></div>
    </div>
