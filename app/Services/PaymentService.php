...
class PaymentService
{
     ...
     */
    public function createCheckoutSession(array $items, Order $order): array
    {
     ...
     */
    public function processPayment(Order $order, string $paymentMethod, $cartItems = null): array
    {
        if ($paymentMethod === 'stripe') {
            ...
            return $this->createCheckoutSession($cartItems->toArray(), $order);
        }
